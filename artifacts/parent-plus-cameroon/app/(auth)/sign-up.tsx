...
export default function SignUpScreen() {
  ...
  const verify = async () => {
    ...
    if (result.error) { setMessage(result.error.message); return; }
    if (signUp.status === 'complete') await signUp.finalize({ navigate: () => router.replace('/profile') });
  };
