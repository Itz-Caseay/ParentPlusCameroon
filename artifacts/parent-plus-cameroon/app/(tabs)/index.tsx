...
const copy = {
  EN: {
    hello: "Good morning,",
    name: "Parent",
    subtitle: "Small steps. Stronger families.",
    continue: "Continue learning",
    today: "Today’s gentle practice",
    tip: "Before correcting, connect.",
    tipBody:
      "Get close, lower your voice, and name what your child may be feeling.",
    support: "Need support right now?",
    supportBody: "Find calm, practical guidance for common parenting moments.",
  },
  FR: {
    hello: "Bonjour,",
    name: "Parent",
    subtitle: "De petits pas. Des familles plus fortes.",
    continue: "Continuer à apprendre",
    today: "La pratique douce du jour",
    tip: "Avant de corriger, connectez-vous.",
    tipBody:
      "Approchez-vous, baissez la voix et nommez ce que votre enfant peut ressentir.",
    support: "Besoin de soutien maintenant ?",
    supportBody: "Des conseils pratiques pour les moments difficiles.",
  },
};
...
export default function HomeScreen() {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.hero, { backgroundColor: colors.primary }]}>
        <View style={styles.heroCopy}>
          ...
          <Text style={styles.heroMeta}>
            {childAge} · {completed.length} lessons completed
          </Text>
        </View>
      ...
      >
        <Feather name="user-plus" size={17} color={colors.primaryForeground} />
      ...
      <Pressable
        ...
        style={[styles.supportCard, { backgroundColor: colors.secondary }]}
      >
        <View style={{ flex: 1 }}>
        ...
        <View style={[styles.circleArrow, { backgroundColor: colors.card }]}>
