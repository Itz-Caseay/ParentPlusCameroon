...
const lessons = [
  {
    id: 1, icon: "heart", duration: "5 min", cat: { en: "Emotional support", fr: "Soutien émotionnel" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Understanding Your Child's Emotions", fr: "Comprendre les émotions de votre enfant" }, need: "emotions", ageGroups: ["0-2","3-6","7-12","13+"],
  ...
  {
    id: 2, icon: "message-circle", duration: "6 min", cat: { en: "Communication", fr: "Communication" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Positive Communication at Home", fr: "Communication positive à la maison" }, need: "communication", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 3, icon: "shield-check", duration: "7 min", cat: { en: "Positive discipline", fr: "Discipline positive" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Discipline Without Violence", fr: "La discipline sans violence" }, need: "discipline", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 4, icon: "puzzle", duration: "6 min", cat: { en: "Conflict management", fr: "Gestion des conflits" }, level: { en: "Intermediate", fr: "Intermédiaire" }, title: { en: "Managing Parent-Child Conflict", fr: "Gérer les conflits parent-enfant" }, need: "discipline", ageGroups: ["7-12","13+"],
  ...
  {
    id: 5, icon: "book-open", duration: "5 min", cat: { en: "Learning support", fr: "Soutien à l'apprentissage" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Supporting Learning at Home", fr: "Soutenir l'apprentissage à la maison" }, need: "school", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 6, icon: "house", duration: "5 min", cat: { en: "Safe home", fr: "Foyer sûr" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Creating a Safe Home Environment", fr: "Créer un environnement domestique sûr" }, need: "autonomy", ageGroups: ["0-2","3-6","7-12"],
  ...
  {
    id: 7, icon: "hand-heart", duration: "6 min", cat: { en: "Relationships", fr: "Relations" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Building Trust and Secure Attachment", fr: "Construire la confiance et un lien sûr" }, need: "emotions", ageGroups: ["0-2","3-6","7-12"],
  ...
  {
    id: 8, icon: "star", duration: "5 min", cat: { en: "Communication", fr: "Communication" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "The Power of Praise and Encouragement", fr: "Le pouvoir des félicitations et des encouragements" }, need: "communication", ageGroups: ["0-2","3-6","7-12","13+"],
  ...
  {
    id: 9, icon: "ear", duration: "5 min", cat: { en: "Emotional support", fr: "Soutien émotionnel" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Listening to Your Child's Feelings", fr: "Écouter les sentiments de votre enfant" }, need: "communication", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 10, icon: "compass", duration: "6 min", cat: { en: "Positive discipline", fr: "Discipline positive" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Setting Limits with Kindness", fr: "Fixer des limites avec bienveillance" }, need: "discipline", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 11, icon: "angry", duration: "6 min", cat: { en: "Emotional support", fr: "Soutien émotionnel" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Helping Your Child Handle Anger", fr: "Aider votre enfant à gérer la colère" }, need: "emotions", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 12, icon: "users", duration: "6 min", cat: { en: "Social development", fr: "Développement social" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Supporting Friendships and Social Skills", fr: "Soutenir les amitiés et les compétences sociales" }, need: "communication", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 13, icon: "circle-help", duration: "5 min", cat: { en: "Learning support", fr: "Soutien à l'apprentissage" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Encouraging Curiosity and Questions", fr: "Encourager la curiosité et les questions" }, need: "school", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 14, icon: "wind", duration: "5 min", cat: { en: "Self-care", fr: "Prendre soin de soi" }, level: { en: "Intermediate", fr: "Intermédiaire" }, title: { en: "Managing Your Own Stress as a Parent", fr: "Gérer votre propre stress de parent" }, need: "emotions", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 15, icon: "clock", duration: "6 min", cat: { en: "Home", fr: "Foyer" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Family Routines and Predictable Schedules", fr: "Routines familiales et emplois du temps prévisibles" }, need: "autonomy", ageGroups: ["0-2","3-6","7-12"],
  ...
  {
    id: 16, icon: "message-square", duration: "7 min", cat: { en: "Communication", fr: "Communication" }, level: { en: "Intermediate", fr: "Intermédiaire" }, title: { en: "Talking About Difficult Topics", fr: "Parler des sujets difficiles" }, need: "communication", ageGroups: ["7-12","13+"],
  ...
  {
    id: 17, icon: "backpack", duration: "6 min", cat: { en: "Learning support", fr: "Soutien à l'apprentissage" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Supporting School Transitions", fr: "Soutenir les transitions scolaires" }, need: "school", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 18, icon: "sparkles", duration: "6 min", cat: { en: "Emotional support", fr: "Soutien émotionnel" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Building Healthy Self-Esteem", fr: "Construire une estime de soi saine" }, need: "emotions", ageGroups: ["3-6","7-12","13+"],
  ...
  {
    id: 19, icon: "wrench", duration: "6 min", cat: { en: "Conflict management", fr: "Gestion des conflits" }, level: { en: "Intermediate", fr: "Intermédiaire" }, title: { en: "Problem-Solving Together", fr: "Résoudre les problèmes ensemble" }, need: "discipline", ageGroups: ["7-12","13+"],
  ...
  {
    id: 20, icon: "party-popper", duration: "5 min", cat: { en: "Relationships", fr: "Relations" }, level: { en: "Beginner", fr: "Débutant" }, title: { en: "Celebrating Small Wins as a Family", fr: "Célébrer les petites victoires en famille" }, need: "emotions", ageGroups: ["0-2","3-6","7-12","13+"],
...
const communityPosts = {
  campaigns: [
    { icon: "heart", title: { en: "7-Day Positive Communication Challenge", fr: "Défi de communication positive de 7 jours" }, text: { en: "Try one active-listening habit each day and reflect on what changed.", fr: "Essayez une habitude d'écoute active chaque jour et réfléchissez à ce qui a changé." }, pill: { en: "Campaign", fr: "Campagne" } },
    { icon: "leaf", title: { en: "Positive Discipline Week", fr: "Semaine de la discipline positive" }, text: { en: "Join thousands of parents practicing respectful limits for one week.", fr: "Rejoignez des milliers de parents qui pratiquent des limites respectueuses pendant une semaine." }, pill: { en: "Campaign", fr: "Campagne" } },
    { icon: "handshake", title: { en: "Family Connection Challenge", fr: "Défi connexion familiale" }, text: { en: "Spend 10 minutes of screen-free time with your child each day.", fr: "Passer 10 minutes sans écran avec votre enfant chaque jour." }, pill: { en: "Campaign", fr: "Campagne" } }
  ],
  resources: [
    { icon: "book", title: { en: "Helping Children Learn at Home", fr: "Aider les enfants à apprendre à la maison" }, text: { en: "Simple routines that support learning without turning home into another classroom.", fr: "Des routines simples qui soutiennent l'apprentissage sans transformer la maison en salle de classe." }, pill: { en: "Resource", fr: "Ressource" } },
    { icon: "book-open", title: { en: "Parenting Guide: Ages 0-5", fr: "Guide parental : 0-5 ans" }, text: { en: "Practical tips for the early years of parenting.", fr: "Conseils pratiques pour les premières années de parentalité." }, pill: { en: "Resource", fr: "Ressource" } },
    { icon: "clapperboard", title: { en: "Video: Calm Parenting Techniques", fr: "Vidéo : Techniques de parenting calme" }, text: { en: "Watch short demonstrations of positive discipline strategies.", fr: "Regardez de courtes démonstrations de stratégies de discipline positive." }, pill: { en: "Resource", fr: "Ressource" } }
  ],
  events: [
    { icon: "users", title: { en: "Parent Discussion Session", fr: "Session de discussion entre parents" }, text: { en: "Space for announcements from trusted community partners.", fr: "Espace pour les annonces des partenaires communautaires de confiance." }, pill: { en: "Event", fr: "Événement" } },
    { icon: "graduation-cap", title: { en: "Online Workshop: Positive Communication", fr: "Atelier en ligne : Communication positive" }, text: { en: "Learn practical communication skills with an expert.", fr: "Apprenez des compétences pratiques de communication avec un expert." }, pill: { en: "Event", fr: "Événement" } },
    { icon: "calendar", title: { en: "Community Meetup", fr: "Rencontre communautaire" }, text: { en: "Connect with other parents in your area.", fr: "Connectez-vous avec d'autres parents de votre région." }, pill: { en: "Event", fr: "Événement" } }
  ]
};

const situations = [
  { icon: "flame", key: "tantrums", supportId: 1 },
  { icon: "smartphone", key: "screens", supportId: 2 },
  { icon: "backpack", key: "homework", supportId: 3 },
  { icon: "moon", key: "bedtime", supportId: 5 },
  { icon: "message-square", key: "arguments", supportId: 4 },
  { icon: "heart-crack", key: "relationship", supportId: 6 }
];
...
const iconSvgs = {
  "message-circle": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719" /> </svg>',
  "book-open": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 5v16" /> <path d="M20.001 19A2 2 0 0022 17V5a2 2 0 00-1.999-2L16 3.002A5 5 0 0012 5a5 5 0 00-4-2H4a2 2 0 00-2 2v12a2 2 0 001.999 2H8a5 5 0 014 2 5 5 0 014-2z" /> </svg>',
  "compass": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z" /> </svg>',
  ...
  "wind": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12.8 19.6A2 2 0 1 0 14 16H2" /> <path d="M17.5 8a2.5 2.5 0 1 1 2 4H2" /> <path d="M9.8 4.4A2 2 0 1 1 11 8H2" /> </svg>',
  "star": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z" /> </svg>',
  "pencil": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z" /> <path d="m15 5 4 4" /> </svg>',
  ...
  "puzzle": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68l1.683-1.682a2.414 2.414 0 0 1 3.414 0z" /> </svg>',
  "house": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8" /> <path d="M3 10a2 2 0 0 1 .709-1.528l7-6a2 2 0 0 1 2.582 0l7 6A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /> </svg>',
  "hand-heart": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M11 14h2a2 2 0 0 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 16" /> <path d="m14.45 13.39 5.05-4.694C20.196 8 21 6.85 21 5.75a2.75 2.75 0 0 0-4.797-1.837.276.276 0 0 1-.406 0A2.75 2.75 0 0 0 11 5.75c0 1.2.802 2.248 1.5 2.946L16 11.95" /> <path d="m2 15 6 6" /> <path d="m7 20 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a1 1 0 0 0-2.75-2.91" /> </svg>',
  "ear": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M6 8.5a6.5 6.5 0 1 1 13 0c0 6-6 6-6 10a3.5 3.5 0 1 1-7 0" /> <path d="M15 8.5a2.5 2.5 0 0 0-5 0v1a2 2 0 1 1 0 4" /> </svg>',
  "angry": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15 12v-1.584" /> <path d="M17 10a5 5 0 00-3 1" /> <path d="M7 10a5 5 0 013 1" /> <path d="M9 12v-1.584" /> <path d="M9 17a5 5 0 016.001 0" /> <circle cx="12" cy="12" r="10" /> </svg>',
  ...
  "circle-help": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" /> <path d="M12 17h.01" /> </svg>',
  "clock": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="M12 6v6l4 2" /> </svg>',
  "message-square": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z" /> </svg>',
  "backpack": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M4 10a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z" /> <path d="M8 10h8" /> <path d="M8 18h8" /> <path d="M8 22v-6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v6" /> <path d="M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2" /> </svg>',
  ...
  "bar-chart-3": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M3 3v16a2 2 0 0 0 2 2h16" /> <path d="M18 17V9" /> <path d="M13 17V5" /> <path d="M8 17v-3" /> </svg>',
  "moon": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401" /> </svg>',
  "heart-crack": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12.409 5.824c-.702.792-1.15 1.496-1.415 2.166l2.153 2.156a.5.5 0 0 1 0 .707l-2.293 2.293a.5.5 0 0 0 0 .707L12 15" /> <path d="M13.508 20.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5a5.5 5.5 0 0 1 9.591-3.677.6.6 0 0 0 .818.001A5.5 5.5 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5z" /> </svg>',
  "flame": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M12 3q1 4 4 6.5t3 5.5a1 1 0 0 1-14 0 5 5 0 0 1 1-3 1 1 0 0 0 5 0c0-2-1.5-3-1.5-5q0-2 2.5-4" /> </svg>',
  ...
  "handshake": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m11 17 2 2a1 1 0 1 0 3-3" /> <path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-.88.88a1 1 0 1 1-3-3l2.81-2.81a5.79 5.79 0 0 1 7.06-.87l.47.28a2 2 0 0 0 1.42.25L21 4" /> <path d="m21 3 1 11h-2" /> <path d="M3 3 2 14l6.5 6.5a1 1 0 1 0 3-3" /> <path d="M3 4h8" /> </svg>',
  "book": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20" /> </svg>',
  "clapperboard": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m12.296 3.464 3.02 3.956" /> <path d="M20.2 6 3 11l-.9-2.4c-.3-1.1.3-2.2 1.3-2.5l13.5-4c1.1-.3 2.2.3 2.5 1.3z" /> <path d="M3 11h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /> <path d="m6.18 5.276 3.1 3.899" /> </svg>',
  ...
  "calendar": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M8 2v3" /> <path d="M16 2v3" /> <rect x="3" y="3" width="18" height="18" rx="2" /> <path d="M3 9h18" /> </svg>',
  ...
  "moon-star": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M18 5h4" /> <path d="M20 3v4" /> <path d="M20.985 12.486a9 9 0 1 1-9.473-9.472c.405-.022.617.46.402.803a6 6 0 0 0 8.268 8.268c.344-.215.825-.004.803.401" /> </svg>',
  "swords": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m13 19 6-6" /> <path d="M14.5 17.5 3.586 6.586A2 2 0 013 5.172V3h2.172a2 2 0 011.414.586L17.5 14.5" /> <path d="m14.828 6.172 2.586-2.586A2 2 0 0118.828 3H21v2.172a2 2 0 01-.586 1.414l-2.586 2.586" /> <path d="m16 16 4 4" /> <path d="m19 21 2-2" /> <path d="m5 14 4 4" /> <path d="m5 21-2-2" /> <path d="M7.5 16.5 4 20" /> </svg>',
  "hourglass": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M5 22h14" /> <path d="M5 2h14" /> <path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22" /> <path d="M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2" /> </svg>',
  "meh": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M15 10V9" /> <path d="M8 16h8" /> <path d="M9 10V9" /> <circle cx="12" cy="12" r="10" /> </svg>',
  "search": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="m21 21-4.34-4.34" /> <circle cx="11" cy="11" r="8" /> </svg>',
  ...
  "life-buoy": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <circle cx="12" cy="12" r="10" /> <path d="m4.93 4.93 4.24 4.24" /> <path d="m14.83 9.17 4.24-4.24" /> <path d="m14.83 14.83 4.24 4.24" /> <path d="m9.17 14.83-4.24 4.24" /> <circle cx="12" cy="12" r="4" /> </svg>',
  "school": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M14 21v-3a2 2 0 0 0-4 0v3" /> <path d="M18 4.933V21" /> <path d="m4 6 7.106-3.79a2 2 0 0 1 1.788 0L20 6" /> <path d="m6 11-3.52 2.147a1 1 0 0 0-.48.854V19a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5a1 1 0 0 0-.48-.853L18 11" /> <path d="M6 4.933V21" /> <circle cx="12" cy="9" r="2" /> </svg>',
  "users-round": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M18 21a8 8 0 0 0-16 0" /> <circle cx="10" cy="8" r="5" /> <path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3" /> </svg>',
  ...
  "utensils": '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" > <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2" /> <path d="M7 2v20" /> <path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7" /> </svg>',
};
...
function lesson(id) {
  ...
  return `<section class="lesson-content"><div class="lesson-hero"><span class="pill">${tr(l.cat)}</span><h1><span class="lesson-title-icon">${iconSvgs[l.icon]}</span> ${tr(l.title)}</h1><p class="muted">${l.duration} · ${tr(l.level)}</p></div><article class="card"><h2>${t("whyMatters")}</h2><p>${tr(l.why)}</p></article><article class="card"><h2>${t("threeThings")}</h2><ol>${l.points.map(p=>`<li>${tr(p)}</li>`).join("")}</ol><div class="tip"><strong>${t("lessonTip")}</strong> ${tr(l.tip)}</div></article>${quizzes}<div class="lesson-extras"><button class="secondary btn-with-icon" onclick="listenLessonText(this)"><span class="iconic" data-icon="volume"></span> ${t("listenLesson")}</button></div><p id="completionMsg" class="completion-msg"></p><div class="form-actions"><button class="secondary" onclick="go('academy')">${t("back")}</button><button class="primary" onclick="finishLesson(${l.id})">${completed(l.id)?t("completed"):t("markComplete")}</button></div></section>`;
}
...
function onboarding(){
  ...
  return `<section class="section"><div class="form-card card onboarding-card" style="max-width:640px"><h2>${t("onboardingTitle")}</h2><p class="muted">${t("onboardingMuted")}</p><form onsubmit="doOnboarding(event)"><div class="onboarding-options">${onboardingGoals.map(g=>`<label class="onboarding-option${onboardingSelected.includes(g.id)?" active":""}"><input type="checkbox" name="onboardingGoal" value="${g.id}" ${onboardingSelected.includes(g.id)?"checked":""} onchange="toggleOnboardingOption(this)"><span class="onboarding-option-icon">${iconSvgs[g.icon]}</span><span class="onboarding-option-text"><strong>${t(g.titleKey)}</strong><span class="muted">${t(g.descKey)}</span></span></label>`).join("")}<label class="onboarding-option${otherChecked?" active":""}"><input type="checkbox" name="onboardingGoal" value="other" ${otherChecked?"checked":""} onchange="toggleOnboardingOption(this)"><span class="onboarding-option-icon">${iconSvgs["pencil"]}</span><span class="onboarding-option-text"><strong>${t("onboardingOptionOther")}</strong></span></label></div><div id="onboardingOtherWrap" style="display:${otherChecked?"block":"none"};margin-top:10px"><textarea id="onboardingOtherInput" rows="3" placeholder="${t("onboardingOtherPlaceholder")}">${escapeHtml(otherValue)}</textarea></div><div class="form-actions" style="margin-top:20px"><button type="button" class="secondary" onclick="skipOnboarding()">${t("onboardingSkip")}</button><button class="primary" type="submit">${t("onboardingSubmit")}</button></div></form></div></section>`;
}
...
function onboardingThanks(){
  if(!state.user)return go("signup");
  setTimeout(()=>{ if((location.hash.replace("#","")||"")==="onboarding-thanks") go("dashboard"); },1000);
  return `<section class="section"><div class="form-card card" style="text-align:center;max-width:520px"><div class="onboarding-thanks-icon">${iconSvgs["heart"]}</div><h2>${t("onboardingThanksTitle")}</h2><p class="muted">${t("onboardingThanksMsg")}</p></div></section>`;
}
...
function dashboard(){
  ...
  return `<section class="dashboard"><div class="dashboard-header"><div><h1>${t("welcome")} ${escapeHtml(state.user.name)} <span class="inline-icon">${iconSvgs["hand"]}</span></h1>${child?`<p class="muted">${t("recommendedForChild")} ${escapeHtml(child.name)}, ${child.age} ${t("years")}</p>`:""}</div></div>${childSelector}<div class="dashboard-section-title"><h3>${t("yourJourney")}</h3></div><div class="kpis"><div class="card kpi"><strong>${progDisplay}%</strong><span>${t("learningProgress")}</span></div><div class="card kpi"><strong>${completedCount} / ${lessons.length}</strong><span>${t("lessonsCompleted")}</span></div><div class="card kpi"><strong>${Math.min(completedCount,7)} ${t("days")}</strong><span>🔥 ${t("streak")}</span></div><div class="card kpi"><strong>${pts}</strong><span>🏆 ${t("points")}</span></div></div><div class="dashboard-grid" style="margin-top:18px"><div class="card"><div class="section-head"><div><h2>${t("todayTitle")}</h2><p class="muted">${continueLabel}</p></div></div>${next?`<div class="lesson-row"><div class="check">${iconSvgs[next.icon]}</div><div><strong>${tr(next.title)}</strong><div class="muted">${next.duration} · ${tr(next.cat)}</div></div><button class="primary small" onclick="go('lesson-${next.id}')">${t("continue")}</button></div>`:`<div class="success alert">${t("allDone")}</div>`}</div><div class="card"><h3><span class="inline-icon">${iconSvgs["lightbulb"]}</span> ${t("dashTipTitle")}</h3><p>${tr(tip)}</p><button class="secondary" onclick="go('support')" style="margin-top:12px">${t("moreSupport")}</button></div></div>${child?`<div class="card" style="margin-top:18px"><h3>${t("progressLabel")} ${escapeHtml(child.name)}</h3><div class="progress"><span style="width:${childProgressPct(child)}%"></span></div><p class="muted">${childProgress(child).length} ${t("lessonsCompleted")}</p></div>`:""}</section>`;
}

function support(){
  return `<section class="section"><div class="section-head"><div><h2>${t("whatsHappening")}</h2><p class="muted">${t("supportMuted")}</p></div></div><div class="grid grid-3">${situations.map(s=>`<article class="card situation-card" onclick="viewGuidance(${s.supportId})"><div class="situation-icon">${iconSvgs[s.icon]}</div><h3>${t("situation"+s.key.charAt(0).toUpperCase()+s.key.slice(1))}</h3><button class="secondary small">${t("viewGuidance")}</button></article>`).join("")}</div><div class="callout" style="margin-top:25px"><div><h2>${t("needFeedback")}</h2><p>${t("feedbackHelps")}</p></div><button class="secondary" onclick="openFeedback()">${t("giveFeedback")}</button></div></section>`;
}

function guidance(id){
  const s=supportTopics.find(x=>x.id===id);if(!s)return go("support");
  return `<section class="lesson-content"><div class="lesson-hero"><span class="eyebrow">${t("guidanceEyebrow")}</span><h1><span class="lesson-title-icon">${iconSvgs[s.icon]}</span> ${tr(s.title)}</h1></div><article class="card"><h3>${t("whatYouCanTry")}</h3><p>${tr(s.detail)}</p></article><div class="form-actions"><button class="secondary" onclick="go('support')">← ${t("backToSupport")}</button></div></section>`;
}
...
function feedbackConfirmation(){return `<section class="section"><div class="form-card card" style="text-align:center"><div class="onboarding-thanks-icon">${iconSvgs["heart"]}</div><h2>${t("feedbackConfirmation")}</h2><p class="muted">${t("feedbackConfirmMsg")}</p><div class="profile-stars">${iconSvgs["star"]}${iconSvgs["star"]}${iconSvgs["star"]}${iconSvgs["star"]}${iconSvgs["star"]}</div><button class="primary" onclick="go('dashboard')" style="margin-top:20px">${t("backToHome")}</button></div></section>`;}
...
function notificationsView(){
  if(!state.user)return go("signup");
  const typeIcons={lesson:"book-open",tip:"lightbulb",progress:"target",reminder:"bell"};
  return `<section class="section"><div class="section-head"><div><h2>${t("notifications")}</h2></div>${state.notifications.some(n=>!n.read)?`<button class="secondary small" onclick="markAllNotificationsRead();render()">${t("markAllRead")}</button>`:""}</div><div class="notifications-list">${state.notifications.length===0?`<p class="muted">${t("noNotifications")}</p>`:state.notifications.map(n=>`<div class="notification-card ${n.read?"read":"unread"}" onclick="readNotification('${n.id}','${n.type}')"><span class="notif-icon">${iconSvgs[typeIcons[n.type]]||iconSvgs["bell"]}</span><div class="notif-content"><strong>${t(n.titleKey)}</strong><p>${t(n.messageKey)}</p><span class="notif-time">${timeSince(n.timestamp)}</span></div></div>`).join("")}</div></section>`;
}
